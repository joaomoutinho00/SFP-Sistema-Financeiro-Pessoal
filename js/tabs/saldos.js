...
function renderSaldos(container, contas) {
  ...
  const linhas = (lista, corValor) => lista.map((c, i) => `
  ...
  container.innerHTML = `
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(320px,1fr));gap:16px;align-items:start">
      ...
      <div class="card">
        ...
        ${normais.length ? linhas(normais, 'var(--green)') : `<p style="color:var(--text-muted);font-size:14px;text-align:center;padding:16px 0">Nenhuma conta</p>`}
      </div>
